...
module.exports = {
    ...
    updater_api_path_authenticate: `${UPDATER_API_PROTO}://${UPDATER_API_HOST}${UPDATER_API_PATH_AUTHENTICATE}`,
    updater_api_path_files:        `${UPDATER_API_PROTO}://${UPDATER_API_HOST}${UPDATER_API_PATH_FILES}`,
